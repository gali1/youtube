...
.method public constructor <init>(Lacjw;Labzm;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Ljop;->a:Lacjw;

    iput-object p2, p0, Ljop;->b:Labzm;

    iput-object p3, p0, Ljop;->c:Ljava/util/concurrent/Executor;
...
.method private final m(Lybe;Lacns;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 1
    iget-object v0, p0, Ljop;->a:Lacjw;

    iget-object v1, p0, Ljop;->b:Labzm;
    ...
    invoke-direct {v0, p1, v1}, Liyw;-><init>(Ljava/lang/Object;I)V

    iget-object p1, p0, Ljop;->c:Ljava/util/concurrent/Executor;
...
.method public final c(Lacqz;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 1
    iget-object p1, p0, Ljop;->a:Lacjw;

    iget-object v0, p0, Ljop;->b:Labzm;
...
.method public final i(Lybe;Lacns;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Ljop;->m(Lybe;Lacns;)Lcom/google/common/util/concurrent/ListenableFuture;

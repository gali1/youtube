...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Lkr;->c:Landroid/widget/ProgressBar;
...
.method final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Layu;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-virtual {p0, v1, p2}, Lkr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    .line 3
    invoke-interface {v0}, Layu;->b()V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Lkr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lkr;->a:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Lkr;->a:Landroid/graphics/Bitmap;
...
.method public b(Landroid/util/AttributeSet;I)V
    ...
    .line 1
    iget-object v0, p0, Lkr;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lkr;->b:[I
    ...
    .line 2
    invoke-virtual {p1, v2}, Ldba;->n(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Lkr;->c:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v0}, Lkr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 13
    :cond_2
    invoke-virtual {p1, v0}, Ldba;->n(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 14
    invoke-virtual {p0, p2, v2}, Lkr;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

...
.method public final b(Landroid/content/Intent;Lrwz;J)V
    ...
    const-string p4, "com/google/android/libraries/notifications/entrypoints/timezonechanged/TimezoneChangedIntentHandler"

    const-string v0, "TimezoneChangedIntentHandler.java"
    ...
    const-string p2, "Syncing registration statuses due to timezone change."

    invoke-interface {p1, p2}, Laicc;->s(Ljava/lang/String;)V

    :try_start_0
    iget-object p1, p0, Lrrt;->b:Lrng;

    .line 2
    sget-object p2, Lajnx;->g:Lajnx;
    ...
    const-string v5, "TimezoneChangedIntentHandler.java"

    const-string v2, "com/google/android/libraries/notifications/entrypoints/timezonechanged/TimezoneChangedIntentHandler"

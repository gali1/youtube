...
.field private static volatile d:Lojt;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lojt;->c:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lojt;->b:Lj$/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method public static a()Lojt;
    .locals 2
    ...
    sget-object v0, Lojt;->c:Ljava/lang/Object;
...
.method private static final g(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 2
    sget-object p4, Lojt;->a:Ljava/util/concurrent/Executor;
...
.method public final b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, Lojt;->f(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lojt;->b:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Lojt;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Lojt;->b:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    .line 2
    :cond_0
    invoke-static {p1, p2}, Lojt;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 2
    invoke-virtual/range {v1 .. v7}, Lojt;->d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-virtual {v3, v0, v2}, Lohe;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lojt;->f(Landroid/content/ServiceConnection;)Z
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p6}, Lojt;->g(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 14
    iget-object p2, p0, Lojt;->b:Lj$/util/concurrent/ConcurrentHashMap;

...
.method public constructor <init>(Lauuj;Lsdu;Lauuj;Lrsq;Lrrg;Lrzl;)V
    ...
    iput-object p1, p0, Lrrh;->b:Lauuj;

    iput-object p2, p0, Lrrh;->c:Lsdu;

    iput-object p3, p0, Lrrh;->d:Lauuj;

    iput-object p4, p0, Lrrh;->e:Lrsq;

    iput-object p5, p0, Lrrh;->f:Lrrg;

    iput-object p6, p0, Lrrh;->g:Lrzl;
...
.method public final b(Landroid/content/Intent;Lrwz;J)V
    ...
    const-string p3, "com/google/android/libraries/notifications/entrypoints/restart/RestartIntentHandler"

    const-string p4, "runInBackground"

    const-string v0, "RestartIntentHandler.java"
    ...
    const-string p2, "Re-surface notifications and sync registrations due to Restart Intent"
    ...
    iget-object p1, p0, Lrrh;->d:Lauuj;
    ...
    .line 12
    :cond_0
    iget-object p1, p0, Lrrh;->c:Lsdu;

    iget-object v1, p0, Lrrh;->f:Lrrg;
    ...
    :goto_1
    :try_start_1
    iget-object p1, p0, Lrrh;->b:Lauuj;
    ...
    const-string v5, "RestartIntentHandler.java"

    const-string v2, "com/google/android/libraries/notifications/entrypoints/restart/RestartIntentHandler"

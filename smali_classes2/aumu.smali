...
# static fields
.field private static final a:Ljava/lang/String; = "aumu"
...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    .line 2
    iput-object p1, p0, Laumu;->b:Landroid/content/ContentProviderClient;

    const-string p1, "device_params"

    .line 3
    invoke-static {p2, p1}, Lauat;->i(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Laumu;->c:Landroid/net/Uri;
    ...
    iput-object p1, p0, Laumu;->d:Landroid/net/Uri;
    ...
    iput-object p1, p0, Laumu;->e:Landroid/net/Uri;
    ...
    iput-object p1, p0, Laumu;->f:Landroid/net/Uri;
    ...
    iput-object p1, p0, Laumu;->g:Landroid/net/Uri;
...
.method private final h(Lajsg;Landroid/net/Uri;Ljava/lang/String;)Lcom/google/protobuf/MessageLite;
    .locals 1

    .line 1
    invoke-direct {p0, p2, p3}, Laumu;->i(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :cond_0
    :try_start_0
    invoke-interface {p1, p2}, Lajsg;->mergeFrom([B)Lajsg;
    ...
    sget-object p2, Laumu;->a:Ljava/lang/String;
...
.method private final i(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Laumu;->b:Landroid/content/ContentProviderClient;
    ...
    :cond_1
    :try_start_2
    sget-object v1, Laumu;->a:Ljava/lang/String;

    const-string v2, "Invalid params result from ContentProvider query: "

    .line 4
    invoke-static {p1, v2}, Lc;->cD(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method public final a(Lcom/google/vr/sdk/proto/SdkConfiguration$SdkConfigurationRequest;)Laihw;
    ...
    .line 2
    sget-object v0, Lcom/google/vr/ndk/base/SdkConfigurationReader;->DEFAULT_PARAMS:Laihw;
    ...
    iget-object v1, p0, Laumu;->f:Landroid/net/Uri;

    .line 4
    invoke-direct {p0, v0, v1, p1}, Laumu;->h(Lajsg;Landroid/net/Uri;Ljava/lang/String;)Lcom/google/protobuf/MessageLite;
...
.method public final b()Lcom/google/vr/sdk/proto/CardboardDevice$DeviceParams;
    ...
    iget-object v1, p0, Laumu;->c:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Laumu;->h(Lajsg;Landroid/net/Uri;Ljava/lang/String;)Lcom/google/protobuf/MessageLite;
...
.method public final c()Lcom/google/vr/sdk/proto/CardboardDevice$DeviceParamsList;
    ...
    iget-object v1, p0, Laumu;->g:Landroid/net/Uri;
...
.method public final d()Lcom/google/vr/sdk/proto/Display$DisplayParams;
    ...
    iget-object v1, p0, Laumu;->e:Landroid/net/Uri;
...
.method public final e()Lcom/google/vr/sdk/proto/Preferences$UserPrefs;
    ...
    iget-object v1, p0, Laumu;->d:Landroid/net/Uri;
...
.method public final f()V
    ...
    .line 1
    iget-object v0, p0, Laumu;->b:Landroid/content/ContentProviderClient;
...
.method public final g(Lcom/google/vr/sdk/proto/CardboardDevice$DeviceParams;)Z
    ...
    .line 1
    iget-object v0, p0, Laumu;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object p1, p0, Laumu;->b:Landroid/content/ContentProviderClient;
    ...
    .line 7
    sget-object v0, Laumu;->a:Ljava/lang/String;

...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->k()Z
...
.method private final j()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lix;
    ...
    iget-object v2, v2, Lix;->l:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lix;->d:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lix;->m:Ljava/lang/CharSequence;
    ...
    .line 8
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lix;

    iget-object v1, v0, Lix;->d:Ljava/lang/CharSequence;

    :goto_3
    invoke-static {p0, v1}, Lqg;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    .line 7
    :cond_6
    invoke-static {p0, v2}, Lqg;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final f(Lix;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lix;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lmt;
    ...
    invoke-direct {p1, p0}, Lik;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lmt;
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Liu;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lix;

    invoke-interface {p1, v0}, Liu;->b(Lix;)Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lix;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lmt;

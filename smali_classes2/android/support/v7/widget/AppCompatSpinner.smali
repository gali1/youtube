...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, v0}, Lpt;->d(Landroid/view/View;Landroid/content/Context;)V

    .line 9
    sget-object v0, Lgu;->v:[I
    ...
    .line 10
    invoke-direct {v2, p0}, Lkj;-><init>(Landroid/view/View;)V

    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Lkj;
    ...
    .line 11
    invoke-direct {v2, p1, p5}, Lsh;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    .line 12
    invoke-virtual {v0, p5, v1}, Ldba;->k(II)I
    ...
    .line 13
    invoke-direct {v2, p1, p5}, Lsh;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p4, p0, v4, p2, p3}, Llc;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object v4, p0, Landroid/support/v7/widget/AppCompatSpinner;->a:Landroid/content/Context;

    sget-object v5, Lgu;->v:[I

    .line 20
    invoke-static {v4, p2, v5, p3, v1}, Ldba;->y(Landroid/content/Context;Landroid/util/AttributeSet;[III)Ldba;
    ...
    .line 21
    invoke-virtual {v4, v5, v6}, Ldba;->j(II)I
    ...
    .line 22
    invoke-virtual {v4, v3}, Ldba;->m(I)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    .line 23
    invoke-virtual {p4, v5}, Lnj;->f(Landroid/graphics/drawable/Drawable;)V

    .line 24
    invoke-virtual {v0, p5}, Ldba;->p(I)Ljava/lang/String;

    move-result-object p5

    iput-object p5, p4, Llc;->a:Ljava/lang/CharSequence;

    .line 25
    invoke-virtual {v4}, Ldba;->q()V

    iput-object p4, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lld;

    .line 26
    new-instance p5, Lkw;

    invoke-direct {p5, p0, p0, p4}, Lkw;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Llc;)V

    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Lmt;
    ...
    invoke-direct {p4, p0}, Lla;-><init>(Landroid/support/v7/widget/AppCompatSpinner;)V
    ...
    invoke-interface {p4, p5}, Lld;->i(Ljava/lang/CharSequence;)V

    .line 17
    :cond_8
    :goto_4
    iget-object p4, v0, Ldba;->a:Ljava/lang/Object;
    ...
    :cond_a
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Lkj;
...
.method public final b()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lld;

    invoke-static {p0}, Lky;->b(Landroid/view/View;)I

    move-result v1

    invoke-static {p0}, Lky;->a(Landroid/view/View;)I

    move-result v2

    invoke-interface {v0, v1, v2}, Lld;->k(II)V
...
.method protected final drawableStateChanged()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Lkj;
...
.method public final getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lld;->c()Landroid/graphics/drawable/Drawable;
...
.method public final getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lld;->d()Ljava/lang/CharSequence;
...
.method protected final onMeasure(II)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lld;
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lld;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Lmt;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lmt;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public final setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-direct {v2, p1, v0}, Llb;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    invoke-interface {v1, v2}, Lld;->e(Landroid/widget/ListAdapter;)V
...
.method public final setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lld;->h(I)V

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lld;

    .line 2
    invoke-interface {v0, p1}, Lld;->g(I)V
...
.method public final setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lld;->j(I)V
...
.method public final setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Lld;->f(Landroid/graphics/drawable/Drawable;)V
...
.method public final setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Lld;->i(Ljava/lang/CharSequence;)V

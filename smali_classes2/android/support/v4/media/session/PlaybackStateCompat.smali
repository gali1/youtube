...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 1
    invoke-static {v1}, Lep;->q(Landroid/media/session/PlaybackState;)Ljava/util/List;
    ...
    .line 5
    invoke-static {v4}, Lep;->m(Landroid/media/session/PlaybackState$CustomAction;)Landroid/os/Bundle;
    ...
    .line 7
    invoke-static {v4}, Lep;->p(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/String;

    move-result-object v7

    .line 8
    invoke-static {v4}, Lep;->o(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/CharSequence;

    move-result-object v8

    .line 9
    invoke-static {v4}, Lep;->b(Landroid/media/session/PlaybackState$CustomAction;)I
    ...
    .line 11
    :goto_2
    invoke-static {v1}, Leq;->a(Landroid/media/session/PlaybackState;)Landroid/os/Bundle;
    ...
    .line 13
    invoke-static {v1}, Lep;->c(Landroid/media/session/PlaybackState;)I

    move-result v8

    .line 14
    invoke-static {v1}, Lep;->h(Landroid/media/session/PlaybackState;)J

    move-result-wide v9

    .line 15
    invoke-static {v1}, Lep;->f(Landroid/media/session/PlaybackState;)J

    move-result-wide v11

    .line 16
    invoke-static {v1}, Lep;->a(Landroid/media/session/PlaybackState;)F

    move-result v13

    .line 17
    invoke-static {v1}, Lep;->d(Landroid/media/session/PlaybackState;)J
    ...
    .line 18
    invoke-static {v1}, Lep;->n(Landroid/media/session/PlaybackState;)Ljava/lang/CharSequence;

    move-result-object v17

    .line 19
    invoke-static {v1}, Lep;->g(Landroid/media/session/PlaybackState;)J

    move-result-wide v18

    .line 20
    invoke-static {v1}, Lep;->e(Landroid/media/session/PlaybackState;)J

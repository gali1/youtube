...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroidx/window/embedding/SplitController$Companion;-><init>(Laxby;)V
...
.method public final addSplitListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lbar;)V
    ...
    :cond_0
    :try_start_1
    invoke-static {p2}, Laxby;->j(Ljava/util/concurrent/Executor;)Laxen;
    ...
    .line 6
    invoke-direct {v2, p0, p1, p3, v3}, Landroidx/window/embedding/SplitController$addSplitListener$1$1;-><init>(Landroidx/window/embedding/SplitController;Landroid/app/Activity;Lbar;Lawzu;)V

    invoke-static {p2, v2}, Laxao;->k(Laxes;Laxbk;)Laxft;
...
.method public final isInvalidatingTopVisibleSplitAttributesSupported()Z
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/window/embedding/SplitController;->embeddingBackend:Landroidx/window/embedding/EmbeddingBackend;

    invoke-interface {v0}, Landroidx/window/embedding/EmbeddingBackend;->areSplitAttributesUpdatesSupported()Z
...
.method public final isUpdatingSplitAttributesSupported()Z
    .locals 1
...
.method public final setSplitAttributesCalculator(Laxbg;)V
    .locals 1
    ...
    .line 2
    invoke-interface {v0, p1}, Landroidx/window/embedding/EmbeddingBackend;->setSplitAttributesCalculator(Laxbg;)V

    return-void
.end method

.method public final splitInfoList(Landroid/app/Activity;)Laxih;
    .locals 2
    ...
    .line 2
    invoke-direct {v0, p0, p1, v1}, Landroidx/window/embedding/SplitController$splitInfoList$1;-><init>(Landroidx/window/embedding/SplitController;Landroid/app/Activity;Lawzu;)V

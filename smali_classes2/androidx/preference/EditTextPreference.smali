...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 6
    invoke-static {p1, p2, p2, p2}, Lawz;->i(Landroid/content/res/TypedArray;IIZ)Z

    move-result p2

    if-eqz p2, :cond_1

    sget-object p2, Ldbs;->b:Ldbs;

    if-nez p2, :cond_0

    new-instance p2, Ldbs;

    const/4 p3, 0x1

    invoke-direct {p2, p3}, Ldbs;-><init>(I)V

    sput-object p2, Ldbs;->b:Ldbs;

    :cond_0
    sget-object p2, Ldbs;->b:Ldbs;

    .line 7
    invoke-virtual {p0, p2}, Landroidx/preference/Preference;->L(Ldca;)V

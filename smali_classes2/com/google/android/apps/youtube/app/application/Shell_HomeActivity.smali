...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->n:Lahgi;
...
.method private final n()Lfvu;
    .locals 1

    .line 1
    invoke-direct {p0}, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->o()V

    iget-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->m:Lfvu;
...
.method private final o()V
    ...
    iget-object v2, v2, Lfpr;->O:Lawxx;
    ...
    iget-object v9, v2, Lfpr;->nZ:Lawxx;

    iget-object v10, v2, Lfpr;->Z:Lawxx;

    iget-object v11, v2, Lfpr;->lM:Lawxx;

    check-cast v1, Lfol;

    iget-object v12, v1, Lfol;->g:Lawxx;

    iget-object v1, v2, Lfpr;->a:Lfpu;

    iget-object v13, v1, Lfpu;->cz:Lawxx;
    ...
    .line 15
    invoke-direct/range {v3 .. v13}, Lfvu;-><init>(Ljava/util/concurrent/Executor;Lxvu;Lwaq;Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;Lagwf;Lawxx;Lawxx;Lawxx;Lawxx;Lawxx;)V

    iput-object v1, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->m:Lfvu;
    :try_end_2
...
.method public final applyOverrideConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Lfvj;->applyOverrideConfiguration(Landroid/content/res/Configuration;)V
...
.method protected final attachBaseContext(Landroid/content/Context;)V
    ...
    invoke-super {p0, p1}, Lfvj;->attachBaseContext(Landroid/content/Context;)V
...
.method protected final e()I
    ...
    .line 1
    invoke-direct {p0}, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->n()Lfvu;

    move-result-object v0

    iget-object v0, v0, Lfvu;->b:Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;

    iget-object v1, v0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->k:Lhbr;

    .line 2
    invoke-virtual {v0}, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->getIntent()Landroid/content/Intent;
...
.method public final finish()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->n:Lahgi;
...
.method public final getLifecycle()Lblc;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->q:Lbli;
    ...
    iput-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->q:Lbli;
...
.method protected final i()Ljava/lang/Class;
    ...
    iget-object v0, v0, Lfvu;->f:Lawxx;
...
.method public final invalidateOptionsMenu()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Lfvj;->invalidateOptionsMenu()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final l(Z)Z
    ...
    iget-object p1, v0, Lfvu;->g:Lawxx;
    ...
    iget-object v1, p1, Layx;->a:Ljava/lang/Object;
    ...
    .line 4
    invoke-virtual {v1, v2}, Lwbn;->u(I)V

    iget-object p1, p1, Layx;->b:Ljava/lang/Object;

    .line 5
    invoke-interface {p1}, Lgfo;->a()V

    :cond_0
    iget-object p1, v0, Lfvu;->c:Ljava/util/concurrent/Executor;

    new-instance v1, Lfvr;

    const/4 v2, 0x4

    invoke-direct {v1, v0, v2}, Lfvr;-><init>(Ljava/lang/Object;I)V
...
.method protected final onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2, p3}, Lfvj;->onActivityResult(IILandroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onBackPressed()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Lfvj;->onBackPressed()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Lfvj;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->n:Lahgi;
    ...
    iget-object p1, p0, Lcom/google/android/apps/youtube/app/application/Shell_HomeActivity;->n:Lahgi;
...
.method public final onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2}, Lfvj;->onCreatePanelMenu(ILandroid/view/Menu;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onNewIntent(Landroid/content/Intent;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Lfvj;->onNewIntent(Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Lfvj;->onOptionsItemSelected(Landroid/view/MenuItem;)Z
...
.method protected final onPause()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Lfvj;->onPause()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onPictureInPictureModeChanged(ZLandroid/content/res/Configuration;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2}, Lfvj;->onPictureInPictureModeChanged(ZLandroid/content/res/Configuration;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onPostCreate(Landroid/os/Bundle;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Lfvj;->onPostCreate(Landroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onPostResume()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Lfvj;->onPostResume()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Lfvj;->onPrepareOptionsMenu(Landroid/view/Menu;)Z
...
.method public final onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2, p3}, Lfvj;->onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onResume()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Lfvj;->onResume()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onSupportNavigateUp()Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Lfvj;->onSupportNavigateUp()Z
...
.method public final onUserInteraction()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Lfvj;->onUserInteraction()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final startActivity(Landroid/content/Intent;)V
    ...
    .line 5
    :cond_0
    invoke-super {p0, p1}, Lfvj;->startActivity(Landroid/content/Intent;)V
...
.method public final startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 10
    :cond_0
    invoke-super {p0, p1, p2}, Lfvj;->startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V

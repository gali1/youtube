...
.method private final b(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Lvsj;->bd(Landroid/content/Context;I)I
    ...
    invoke-direct {v6, v10, v7, v8, v9}, Lrij;-><init>(FII[I)V
    ...
    .line 25
    invoke-virtual {v5, p1}, Lcom/airbnb/lottie/LottieAnimationView;->p(I)V
    ...
    invoke-direct {p1, v3}, Lduz;-><init>([Ljava/lang/String;)V

    sget-object v1, Ldtd;->E:Landroid/graphics/ColorFilter;

    new-instance v3, Ljzc;

    invoke-direct {v3, v2}, Ljzc;-><init>(I)V

    invoke-virtual {v5, p1, v1, v3}, Lcom/airbnb/lottie/LottieAnimationView;->c(Lduz;Ljava/lang/Object;Ldyn;)V

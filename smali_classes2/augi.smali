...
.field public g:Lauar;

.field private h:I


# direct methods
.method public constructor <init>(Ljava/net/HttpURLConnection;Ljava/lang/String;Laugh;Lauge;)V
    .locals 6
    ...
    iput v0, p0, Laugi;->e:I

    const/4 v0, 0x0

    iput v0, p0, Laugi;->f:I

    iput-object p1, p0, Laugi;->a:Ljava/net/HttpURLConnection;
    ...
    iput-object p4, p0, Laugi;->b:Lauge;
    ...
    .line 13
    invoke-virtual {p3, v0}, Laugh;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_3
    iput p2, p0, Laugi;->h:I

    const/high16 p1, 0x10000

    new-array p1, p1, [B

    iput-object p1, p0, Laugi;->c:[B
...
.method public final c()Lauge;
    ...
    iget-object v0, p0, Laugi;->b:Lauge;
...
.method public final g()Z
    ...
    invoke-direct {v1, v2, v0}, Laugv;-><init>(Laugu;Ljava/lang/Throwable;)V
...
.method public final i()Lahih;
    .locals 8

    .line 1
    invoke-virtual {p0}, Laugi;->f()V

    :try_start_0
    iget-object v0, p0, Laugi;->a:Ljava/net/HttpURLConnection;
    ...
    :try_start_1
    iget-object v1, p0, Laugi;->a:Ljava/net/HttpURLConnection;
    ...
    .line 4
    :goto_0
    iget-object v2, p0, Laugi;->a:Ljava/net/HttpURLConnection;
    ...
    .line 10
    invoke-virtual {v3, v5, v7}, Laugh;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lahih;-><init>(ILaugh;Ljava/io/InputStream;)V
...
.method public final declared-synchronized j(Lauar;II)V
    ...
    :try_start_0
    iput-object p1, p0, Laugi;->g:Lauar;

    if-lez p2, :cond_0

    iput p2, p0, Laugi;->e:I

    :cond_0
    iput p3, p0, Laugi;->f:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

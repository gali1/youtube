...
# direct methods
.method static bridge synthetic -$$Nest$fgetvrParamsProvider(Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;)Launv;
    .locals 0

    iget-object p0, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Launv;

    return-object p0
.end method

.method static bridge synthetic -$$Nest$minit(Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Laump;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->init(Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Laump;)V
...
.method public constructor <init>(Lcom/google/vr/ndk/base/GvrLayoutImpl;)V
    ...
    iget v1, v1, Laihw;->daydreamImageAlignment_:I

    .line 3
    invoke-static {v1}, Laiht;->a(I)Laiht;

    move-result-object v1

    if-nez v1, :cond_0

    sget-object v1, Laiht;->UNKNOWN_ALIGNMENT:Laiht;

    :cond_0
    sget-object v2, Laiht;->DISABLED:Laiht;
    ...
    iget-boolean v0, v0, Laihw;->touchOverlayEnabled_:Z
    ...
    iput-object v0, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Launv;
    ...
    .line 8
    invoke-static {p1}, Laumq;->i(Landroid/content/Context;)Landroid/view/Display;
...
.method private init(Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Laump;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/vr/ndk/base/AbstractDaydreamTouchListener;->initWithDisplayParams(Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Laump;)V
...
.method protected logEvent(Laiho;Laihn;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->getLoggingService()Laupa;
    ...
    .line 4
    sget-object v1, Laiho;->Z:Laiho;

    invoke-direct {p1, v1, p2}, Lcom/google/vr/vrcore/logging/api/VREventParcelable;-><init>(Laiho;Laihn;)V
    ...
    invoke-virtual {p2}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->getLoggingService()Laupa;

    move-result-object p2

    invoke-interface {p2, p1}, Laupa;->a(Lcom/google/vr/vrcore/logging/api/VREventParcelable;)V
    :try_end_0
...
.method public shutdown()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Launv;

...
.method private init()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Lauop;
    ...
    invoke-static {v0}, Lcom/google/vr/ndk/base/GvrLayoutFactory;->create(Landroid/content/Context;)Lauop;

    move-result-object v0

    iput-object v0, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Lauop;

    :cond_0
    new-instance v0, Lcom/google/vr/ndk/base/GvrUiLayout;

    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Lauop;

    .line 2
    invoke-interface {v1}, Lauop;->getUiLayout()Lauos;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/vr/ndk/base/GvrUiLayout;-><init>(Lauos;)V
    ...
    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Lauop;

    invoke-interface {v2}, Lauop;->getNativeGvrContext()J
    ...
    .line 4
    invoke-interface {v0}, Lauop;->getRootView()Lauov;

    move-result-object v0

    const-class v1, Landroid/view/View;

    invoke-static {v0, v1}, Lcom/google/vr/vrcore/library/api/ObjectWrapper;->b(Lauov;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public enableAsyncReprojectionProtected()Z
    ...
    invoke-interface {v0, v1}, Lauop;->enableAsyncReprojection(I)Z
...
.method public onPause()V
    ...
    invoke-interface {v0}, Lauop;->onPause()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onResume()V
    ...
    invoke-interface {v0}, Lauop;->onResume()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setAsyncReprojectionEnabled(Z)Z
    ...
    :cond_1
    :try_start_0
    iget-object p1, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Lauop;

    const/4 v0, 0x0

    .line 3
    invoke-interface {p1, v0}, Lauop;->enableAsyncReprojection(I)Z
...
.method public setPresentationView(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Lauop;->setPresentationView(Lauov;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setStereoModeEnabled(Z)V
    ...
    .line 1
    invoke-interface {v0, p1}, Lauop;->setStereoModeEnabled(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public shutdown()V
    ...
    .line 2
    invoke-interface {v0}, Lauop;->shutdown()V

...
# instance fields
.field private androidPCompat:Laumq;
...
.field private eglFactory:Laumv;
...
.field private scanlineRacingRenderer:Launj;
...
# direct methods
.method static bridge synthetic -$$Nest$fgetscanlineRacingRenderer(Lcom/google/vr/ndk/base/GvrLayoutImpl;)Launj;
    .locals 0

    iget-object p0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->scanlineRacingRenderer:Launj;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/ndk/base/ExtensionManager;)V
    ...
    instance-of p2, p1, Launu;

    if-nez p2, :cond_1

    .line 3
    invoke-static {p1}, Laumq;->k(Landroid/content/Context;)Landroid/app/Activity;
...
.method private addScanlineRacingView()V
    ...
    iput-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->eglFactory:Laumv;
    ...
    iput-boolean v1, v0, Laumv;->c:Z

    iget-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->eglFactory:Laumv;

    const/4 v1, 0x1

    iput-boolean v1, v0, Laumv;->a:Z
    ...
    :goto_0
    iput-boolean v2, v0, Laumv;->b:Z

    const/4 v2, 0x3

    iput v2, v0, Laumv;->e:I
    ...
    .line 4
    new-instance v2, Launf;

    invoke-direct {v2}, Launf;-><init>()V
    ...
    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->eglFactory:Laumv;
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->scanlineRacingRenderer:Launj;
    ...
    invoke-direct {v0, v2}, Launj;-><init>(Lcom/google/vr/ndk/base/GvrApi;)V

    iput-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->scanlineRacingRenderer:Launj;
    ...
    .line 13
    iput-object v2, v0, Launj;->a:Lcom/google/vr/ndk/base/GvrSurfaceView;

    .line 14
    invoke-virtual {v2, v0}, Lcom/google/vr/ndk/base/GvrLayoutImpl$AsyncReprojectionSurfaceView;->setRenderer(Launj;)V
...
.method private initWithInjectedObjects(Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/cardboard/DisplaySynchronizer;Lcom/google/vr/cardboard/EglReadyListener;Lcom/google/vr/ndk/base/FadeOverlayView;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;Lcom/google/vr/ndk/base/ExtensionManager;Lcom/google/vr/ndk/base/GvrUiLayoutImpl;Laumq;)V
    ...
    iput-object p8, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->androidPCompat:Laumq;
...
.method private isContextSharingEnabled()Z
    ...
    .line 3
    invoke-virtual {v0}, Lcom/google/vr/ndk/base/GvrApi;->getSdkConfigurationParams()Laihw;

    move-result-object v0

    iget v0, v0, Laihw;->bitField0_:I
    ...
    iget-object v0, v0, Laihw;->asyncReprojectionConfig_:Laihq;

    if-nez v0, :cond_1

    .line 5
    sget-object v0, Laihq;->DEFAULT_INSTANCE:Laihq;

    :cond_1
    iget v2, v0, Laihq;->bitField0_:I
    ...
    iget-wide v4, v0, Laihq;->flags_:J
...
.method private isDeviceDetectionEnabled()Z
    ...
    iget-boolean v0, v0, Laihw;->useDeviceIdleDetection_:Z
...
.method private isDimUiEnabled()Z
    ...
    iget-boolean v0, v0, Laihw;->dimUiLayer_:Z
...
.method private registerLatchListener()V
    ...
    sget-object v2, Lauoy;->a:Landroid/content/ComponentName;
...
.method private tryCreatePresentationHelper()Lcom/google/vr/ndk/base/GvrLayoutImpl$PresentationHelper;
    ...
    invoke-static {v0}, Laumq;->j(Landroid/content/Context;)Ljava/lang/String;
...
.method private updateMarginsForDisplayCutout()V
    ...
    invoke-static {v0}, Laumq;->k(Landroid/content/Context;)Landroid/app/Activity;
    ...
    invoke-static {v1}, Laumq;->i(Landroid/content/Context;)Landroid/view/Display;
...
.method protected createVrCoreSdkClient(Landroid/content/Context;Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;Lcom/google/vr/ndk/base/FadeOverlayView;)Lcom/google/vr/ndk/base/VrCoreSdkClient;
    ...
    .line 1
    invoke-static {p1}, Laumq;->l(Landroid/content/Context;)Landroid/content/ComponentName;
...
.method public enableAsyncReprojection(I)Z
    ...
    iget-object v0, p1, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Laund;

    if-eqz v0, :cond_6

    .line 8
    invoke-virtual {v0}, Laund;->b()V

    const/4 v0, 0x0

    iput-object v0, p1, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Laund;
...
.method public onPause()V
    ...
    invoke-virtual {v1}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->getLoggingService()Laupa;
    ...
    .line 2
    invoke-interface {v0, v1}, Lcom/google/vr/ndk/base/ExtensionManager;->reportTelemetry(Laupa;)V
...
.method public onResume()V
    ...
    iget-object v0, v0, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Laund;

    const/4 v1, 0x1

    if-eqz v0, :cond_1

    iget-boolean v2, v0, Laund;->c:Z

    if-nez v2, :cond_1

    iput-boolean v1, v0, Laund;->c:Z

    iget-object v0, v0, Laund;->b:Landroid/os/Handler;
...
.method public shutdown()V
    ...
    iget-object v1, v0, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Laund;

    if-eqz v1, :cond_0

    .line 2
    invoke-virtual {v1}, Laund;->b()V

...
.method public final a(Landroid/view/View;Lbet;)Lbet;
    ...
    .line 1
    invoke-virtual/range {p2 .. p2}, Lbet;->d()I

    move-result v0

    move-object v1, p0

    iget-object v2, v1, Lfp;->a:Lgh;
    ...
    iget-object v4, v2, Lgh;->p:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v8, v2, Lgh;->p:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v8, v2, Lgh;->F:Landroid/graphics/Rect;
    ...
    iput-object v8, v2, Lgh;->F:Landroid/graphics/Rect;
    ...
    iput-object v8, v2, Lgh;->G:Landroid/graphics/Rect;

    :cond_0
    iget-object v8, v2, Lgh;->F:Landroid/graphics/Rect;

    iget-object v9, v2, Lgh;->G:Landroid/graphics/Rect;

    .line 8
    invoke-virtual/range {p2 .. p2}, Lbet;->b()I
    ...
    .line 10
    invoke-virtual/range {p2 .. p2}, Lbet;->c()I

    move-result v12

    .line 11
    invoke-virtual/range {p2 .. p2}, Lbet;->a()I
    ...
    iget-object v10, v2, Lgh;->t:Landroid/view/ViewGroup;

    .line 13
    sget-object v11, Lqj;->a:Ljava/lang/reflect/Method;
    ...
    iget-object v11, v2, Lgh;->t:Landroid/view/ViewGroup;

    .line 18
    invoke-static {v11}, Lbcz;->b(Landroid/view/View;)Lbet;
    ...
    iget-object v9, v2, Lgh;->u:Landroid/view/View;

    if-nez v9, :cond_6

    new-instance v9, Landroid/view/View;

    iget-object v10, v2, Lgh;->i:Landroid/content/Context;

    .line 31
    invoke-direct {v9, v10}, Landroid/view/View;-><init>(Landroid/content/Context;)V

    iput-object v9, v2, Lgh;->u:Landroid/view/View;
    ...
    iget-object v11, v2, Lgh;->u:Landroid/view/View;
    ...
    iget-object v10, v2, Lgh;->u:Landroid/view/View;
    ...
    .line 38
    invoke-static {v9}, Lbcs;->d(Landroid/view/View;)I
    ...
    iget-object v11, v2, Lgh;->i:Landroid/content/Context;

    const v12, 0x7f06000d

    .line 39
    invoke-static {v11, v12}, Lawv;->a(Landroid/content/Context;I)I
    ...
    :cond_10
    :goto_a
    iget-object v2, v2, Lgh;->u:Landroid/view/View;
    ...
    .line 49
    invoke-virtual {v5, v0, v3, v2, v4}, Lbet;->n(IIII)Lbet;
    ...
    .line 50
    :goto_c
    invoke-static {v2, v0}, Lbdk;->h(Landroid/view/View;Lbet;)Lbet;

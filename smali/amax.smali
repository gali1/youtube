...
.method public static final d(Ljava/lang/String;)Lamaw;
    .locals 3
    ...
    iput v2, v1, Lamba;->c:I

    iput-object p0, v1, Lamba;->f:Ljava/lang/String;

    new-instance p0, Lamaw;

    invoke-direct {p0, v0}, Lamaw;-><init>(Lajql;)V
...
.method public final bridge synthetic b([B)Lyar;
    ...
    invoke-direct {p1, v0}, Lamaw;-><init>(Lajql;)V

...
.method public static final d(Ljava/lang/String;)Lamcs;
    .locals 3
    ...
    iput v2, v1, Lamcx;->c:I

    iput-object p0, v1, Lamcx;->d:Ljava/lang/String;

    new-instance p0, Lamcs;

    invoke-direct {p0, v0}, Lamcs;-><init>(Lajql;)V
...
.method public final bridge synthetic b([B)Lyar;
    ...
    invoke-direct {p1, v0}, Lamcs;-><init>(Lajql;)V

...
.method static constructor <clinit>()V
    ...
    .line 1
    invoke-static {v2, v3, v4, v0, v1}, Laioo;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;

    move-result-object v0

    sput-object v0, Laioo;->a:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v0, Laioo;->b:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v0, Laioo;->c:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v0, Laioo;->d:Ljava/math/BigInteger;
    ...
    sput-object v0, Laioo;->e:Ljava/math/BigInteger;
    ...
    sput-object v0, Laioo;->f:Ljava/math/BigInteger;
    ...
    sput-object v0, Laioo;->g:Ljava/math/BigInteger;

    return-void
.end method

.method public static a(Laion;Laion;Ljava/math/BigInteger;Ljava/math/BigInteger;)Laion;
    .locals 9

    .line 1
    invoke-virtual {p0}, Laion;->a()Z
    ...
    iget-object v1, p1, Laion;->d:Ljava/math/BigInteger;
    ...
    iget-object v2, p0, Laion;->b:Ljava/math/BigInteger;
    ...
    iget-object v3, p1, Laion;->b:Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Laion;->c:Ljava/math/BigInteger;

    iget-object v5, p1, Laion;->d:Ljava/math/BigInteger;
    ...
    iget-object v5, p1, Laion;->c:Ljava/math/BigInteger;

    iget-object v6, p0, Laion;->d:Ljava/math/BigInteger;
    ...
    .line 11
    :cond_2
    invoke-static {p0, p2, p3}, Laioo;->b(Laion;Ljava/math/BigInteger;Ljava/math/BigInteger;)Laion;
    ...
    sget-object v3, Laioo;->f:Ljava/math/BigInteger;
    ...
    sget-object v7, Laioo;->d:Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Laion;->d:Ljava/math/BigInteger;

    iget-object p1, p1, Laion;->d:Ljava/math/BigInteger;
    ...
    invoke-direct {p1, v3, v2, p0}, Laion;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object p1
.end method

.method public static b(Laion;Ljava/math/BigInteger;Ljava/math/BigInteger;)Laion;
    .locals 7

    .line 1
    iget-object v0, p0, Laion;->c:Ljava/math/BigInteger;
    ...
    :cond_0
    iget-object v0, p0, Laion;->b:Ljava/math/BigInteger;
    ...
    iget-object v1, p0, Laion;->c:Ljava/math/BigInteger;
    ...
    iget-object v3, p0, Laion;->d:Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Laion;->b:Ljava/math/BigInteger;
    ...
    sget-object v5, Laioo;->d:Ljava/math/BigInteger;

    invoke-virtual {v4, v5}, Ljava/math/BigInteger;->multiply(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v4

    sget-object v6, Laioo;->e:Ljava/math/BigInteger;
    ...
    sget-object v4, Laioo;->g:Ljava/math/BigInteger;
    ...
    iget-object v2, p0, Laion;->c:Ljava/math/BigInteger;
    ...
    invoke-direct {p2, v0, p1, p0}, Laion;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object p2
.end method

.method public static c(Ljava/security/spec/ECPoint;Ljava/math/BigInteger;)Laion;
    .locals 5
    ...
    invoke-direct {v3, v1, p0, v0}, Laion;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static e(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    .line 1
    invoke-static {p1}, Laioo;->d(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;

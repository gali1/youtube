...
.method public static a(Lcom/google/apps/tiktok/account/AccountId;Lxbr;)Lxbq;
    .locals 1
...
.method public final L(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 1
    iget-object v0, p0, Lxbq;->b:Lawvu;
...
.method public final aG(Landroid/content/Intent;)V
    ...
    .line 4
    :cond_0
    invoke-super {p0, p1}, Lxbw;->aG(Landroid/content/Intent;)V
...
.method public final ac(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 1
    iget-object p2, p0, Lxbq;->b:Lawvu;
    ...
    iget-object v0, p2, Lxbv;->g:Ljava/lang/Integer;

    if-eqz v0, :cond_0

    iget-object v1, p2, Lxbv;->l:Lajad;
    ...
    iget-object v0, p2, Lxbv;->h:Ljava/lang/Integer;
    ...
    iget-object v0, p2, Lxbv;->b:Lalsw;
    ...
    .line 11
    invoke-virtual {v0, v2}, Lalsw;->equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    :goto_0
    iget-object v0, p2, Lxbv;->e:Landroid/content/Context;
    ...
    iget-object v1, p2, Lxbv;->k:Laixs;
    ...
    .line 17
    invoke-virtual {v1, v2}, Laixs;->c(Landroid/widget/TextView;)Lafdd;

    move-result-object v1

    iput-object v1, p2, Lxbv;->d:Lafdd;

    .line 18
    sget-object v1, Lxbm;->a:Lahup;
    ...
    .line 20
    invoke-virtual {p2}, Lxbv;->a()V

    goto :goto_1

    .line 38
    :cond_3
    iget-object v1, p2, Lxbv;->b:Lalsw;

    sget-object v3, Lxbm;->a:Lahup;
    ...
    .line 26
    invoke-virtual {p2, v0, v2}, Lxbv;->b(Ljava/lang/String;I)V

    iget-object v0, p2, Lxbv;->d:Lafdd;
    ...
    invoke-direct {v1, p2, v3}, Llok;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v1, p2, v0}, Lxbs;-><init>(Ljava/lang/Object;I)V

    .line 29
    invoke-virtual {p1, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    :cond_5
    iget-object p1, p2, Lxbv;->l:Lajad;
    ...
    iget-object p1, p2, Lxbv;->g:Ljava/lang/Integer;

    if-eqz p1, :cond_6

    iget-object p2, p2, Lxbv;->l:Lajad;
...
.method public final d()Lxbv;
    .locals 2

    .line 1
    iget-object v0, p0, Lxbq;->a:Lxbv;

    if-eqz v0, :cond_1

    iget-boolean v1, p0, Lxbq;->e:Z
...
.method public final mT()Landroid/content/Context;
    ...
    .line 1
    invoke-super {p0}, Lxbw;->mT()Landroid/content/Context;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lxbq;->c:Landroid/content/Context;
    ...
    iput-object v0, p0, Lxbq;->c:Landroid/content/Context;
...
.method public final nV(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
    ...
    .line 1
    iget-object p1, p0, Lxbq;->b:Lawvu;
...
.method public final nW(Landroid/content/Context;)V
    ...
    .line 1
    iget-object v1, p0, Lxbq;->b:Lawvu;
    ...
    .line 3
    invoke-super {p0, p1}, Lxbw;->nW(Landroid/content/Context;)V

    iget-object p1, p0, Lxbq;->a:Lxbv;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 4
    :try_start_1
    invoke-virtual {p0}, Lxbw;->aQ()Ljava/lang/Object;
    ...
    iget-object v0, v0, Lfrl;->Q:Lawxx;
    ...
    .line 15
    invoke-direct/range {v3 .. v9}, Lxbv;-><init>(Lxbq;Lxbr;Laixs;Landroid/content/Context;Lajad;Lzsp;)V

    iput-object p1, p0, Lxbq;->a:Lxbv;
...
.method public final tp(Landroid/app/Activity;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Lxbw;->tp(Landroid/app/Activity;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

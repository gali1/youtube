...
# static fields
.field static final a:Lahuj;

.field static final b:Lahuj;

.field public static final c:Lahuj;

.field static final d:Lahuj;
...
.method static constructor <clinit>()V
    ...
    .line 1
    invoke-static {v1, v2, v3, v4, v0}, Lahuj;->v(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lahuj;

    move-result-object v0

    sput-object v0, Lwnh;->a:Lahuj;

    .line 2
    invoke-static {v1, v2, v3, v4}, Lahuj;->u(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lahuj;

    move-result-object v0

    sput-object v0, Lwnh;->b:Lahuj;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lwnh;->e:Landroid/content/ContentResolver;
    ...
    iput-object p1, p0, Lwnh;->f:Landroid/content/res/Resources;
...
.method private final g(Landroid/database/Cursor;IIIIII)Lcom/google/android/libraries/youtube/creation/common/util/DeviceLocalFile;
    ...
    invoke-static {p2}, Lc;->aA(I)Z

    move-result p4

    if-eqz p4, :cond_2

    iget-object p4, p0, Lwnh;->f:Landroid/content/res/Resources;
    ...
    .line 9
    :cond_6
    invoke-static {p2}, Lwnh;->f(I)Landroid/net/Uri;
    ...
    .line 14
    invoke-static {v6, p3}, Lwha;->d(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 16
    invoke-virtual {p3, v2, v3}, Lwng;->e(J)V

    .line 17
    invoke-virtual {p3, p5}, Lwng;->h(Landroid/net/Uri;)V

    .line 18
    invoke-virtual {p3, p4}, Lwng;->b(Ljava/lang/String;)V
    ...
    iput-object p1, p3, Lwng;->a:Ljava/lang/String;

    .line 20
    invoke-virtual {p3, v4, v5}, Lwng;->g(J)V

    .line 21
    invoke-virtual {p3, p6, p7}, Lwng;->c(J)V

    .line 22
    invoke-virtual {p3, v0, v1}, Lwng;->f(J)V

    .line 23
    invoke-virtual {p3, p2}, Lwng;->d(I)V

    .line 24
    invoke-virtual {p3}, Lwng;->a()Lcom/google/android/libraries/youtube/creation/common/util/DeviceLocalFile;
...
.method private final h(I)Ljava/util/List;
    ...
    .line 1
    invoke-static/range {p1 .. p1}, Lc;->aA(I)Z
    ...
    .line 1
    :try_start_0
    iget-object v2, v13, Lwnh;->e:Landroid/content/ContentResolver;

    .line 3
    invoke-static/range {p1 .. p1}, Lwnh;->f(I)Landroid/net/Uri;
    ...
    .line 16
    invoke-direct/range {v5 .. v12}, Lwnh;->g(Landroid/database/Cursor;IIIIII)Lcom/google/android/libraries/youtube/creation/common/util/DeviceLocalFile;
...
.method public final a(Landroid/database/Cursor;I)Lcom/google/android/libraries/youtube/creation/common/util/DeviceLocalFile;
    ...
    .line 8
    invoke-direct/range {v2 .. v9}, Lwnh;->g(Landroid/database/Cursor;IIIIII)Lcom/google/android/libraries/youtube/creation/common/util/DeviceLocalFile;
...
.method public final b()Lcom/google/android/libraries/youtube/creation/common/util/DeviceLocalFile;
    .locals 4

    .line 1
    sget-object v0, Landroid/provider/MediaStore$Video$Media;->EXTERNAL_CONTENT_URI:Landroid/net/Uri;

    sget-object v1, Lwnh;->d:Lahuj;
    ...
    .line 3
    invoke-virtual {p0, v0, v1}, Lwnh;->e(Landroid/net/Uri;[Ljava/lang/String;)Landroid/database/Cursor;

    move-result-object v0

    .line 4
    invoke-virtual {p0, v0, v2}, Lwnh;->a(Landroid/database/Cursor;I)Lcom/google/android/libraries/youtube/creation/common/util/DeviceLocalFile;
...
.method public final c(I)Ljava/util/List;
    ...
    .line 3
    invoke-direct {p0, p1}, Lwnh;->h(I)Ljava/util/List;
    ...
    .line 4
    invoke-direct {p0, v0}, Lwnh;->h(I)Ljava/util/List;
...
.method public final d(I)Ljava/util/Map;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lwnh;->c(I)Ljava/util/List;
...
.method public final e(Landroid/net/Uri;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object v2, p0, Lwnh;->e:Landroid/content/ContentResolver;
    ...
    :cond_0
    iget-object v1, p0, Lwnh;->e:Landroid/content/ContentResolver;

    const/4 v4, 0x0

    const/4 v5, 0x0

    const-string v6, "date_modified DESC LIMIT 1"

...
.method private constructor <init>(Landroid/net/Uri;Ljava/security/MessageDigest;J)V
    ...
    iput-object p2, p0, Ltwm;->b:Ljava/security/MessageDigest;

    iput-object p1, p0, Ltwm;->a:Landroid/net/Uri;

    iput-wide p3, p0, Ltwm;->c:J

    return-void
.end method

.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;)Ltwm;
    .locals 6
    ...
    invoke-direct {v0, p1, v4, v1, v2}, Ltwm;-><init>(Landroid/net/Uri;Ljava/security/MessageDigest;J)V
    :try_end_2

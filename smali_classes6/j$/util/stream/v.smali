...
.field private final b:Lj$/util/stream/k1;

.field private final c:Lj$/util/stream/J;

.field private d:J


# direct methods
.method constructor <init>(Lj$/util/stream/J;Lj$/util/Spliterator;Lj$/util/stream/k1;)V
    .locals 1
    ...
    iput-object p3, p0, Lj$/util/stream/v;->b:Lj$/util/stream/k1;

    iput-object p1, p0, Lj$/util/stream/v;->c:Lj$/util/stream/J;
...
.method constructor <init>(Lj$/util/stream/v;Lj$/util/Spliterator;)V
    ...
    iget-object p2, p1, Lj$/util/stream/v;->b:Lj$/util/stream/k1;

    iput-object p2, p0, Lj$/util/stream/v;->b:Lj$/util/stream/k1;

    iget-wide v0, p1, Lj$/util/stream/v;->d:J

    iput-wide v0, p0, Lj$/util/stream/v;->d:J

    iget-object p1, p1, Lj$/util/stream/v;->c:Lj$/util/stream/J;
...
.method public final compute()V
    ...
    :cond_0
    sget-object v5, Lj$/util/stream/F1;->SHORT_CIRCUIT:Lj$/util/stream/F1;

    iget-object v6, p0, Lj$/util/stream/v;->c:Lj$/util/stream/J;

    invoke-virtual {v6}, Lj$/util/stream/J;->y()I

    move-result v6

    invoke-virtual {v5, v6}, Lj$/util/stream/F1;->e(I)Z

    move-result v5

    iget-object v6, p0, Lj$/util/stream/v;->b:Lj$/util/stream/k1;
    ...
    invoke-interface {v6}, Lj$/util/stream/k1;->l()Z
    ...
    :cond_4
    :goto_2
    iget-object v1, v8, Lj$/util/stream/v;->c:Lj$/util/stream/J;

    invoke-virtual {v1, v0, v6}, Lj$/util/stream/J;->v(Lj$/util/Spliterator;Lj$/util/stream/k1;)V

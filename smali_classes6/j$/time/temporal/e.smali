...
.method public final g()Lj$/time/temporal/q;
    ...
    invoke-virtual {v0}, Lj$/time/temporal/a;->g()Lj$/time/temporal/q;
...
.method public final h(Lj$/time/temporal/k;)Z
    ...
    invoke-interface {p1, v0}, Lj$/time/temporal/k;->g(Lj$/time/temporal/l;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Lj$/time/temporal/h;->a(Lj$/time/temporal/k;)Z
...
.method public final i(Lj$/time/temporal/Temporal;J)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p0}, Lj$/time/temporal/e;->g()Lj$/time/temporal/q;
    ...
    invoke-virtual {p3, v0}, Lj$/time/LocalDate;->e(Lj$/time/temporal/l;)I

    move-result v1

    invoke-static {p3}, Lj$/time/temporal/f;->l(Lj$/time/LocalDate;)I
    ...
    invoke-static {p2}, Lj$/time/temporal/f;->p(I)I
    ...
    invoke-virtual {p2, v0}, Lj$/time/LocalDate;->e(Lj$/time/temporal/l;)I
    ...
    invoke-interface {p1, p2}, Lj$/time/temporal/Temporal;->h(Lj$/time/LocalDate;)Lj$/time/temporal/Temporal;

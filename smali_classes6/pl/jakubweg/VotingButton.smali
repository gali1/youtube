...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpl/jakubweg/VotingButton;->TAG:Ljava/lang/String;
...
.method public static changeVisibility(ZZ)V
    ...
    .line 86
    sget-object v1, Lpl/jakubweg/VotingButton;->TAG:Ljava/lang/String;
    ...
    .line 90
    sget-object v1, Lpl/jakubweg/VotingButton;->fadeIn:Landroid/view/animation/Animation;
    ...
    .line 99
    sget-object v1, Lpl/jakubweg/VotingButton;->fadeOut:Landroid/view/animation/Animation;
...
.method public static changeVisibilityNegatedImmediate(Z)V
    ...
    invoke-static {v0, v1}, Lpl/jakubweg/VotingButton;->changeVisibility(ZZ)V
...
.method public static initialize(Ljava/lang/Object;)V
    ...
    sput-object v0, Lpl/jakubweg/VotingButton;->_youtubeControlsLayout:Landroid/widget/RelativeLayout;

    .line 37
    const-string v1, "voting_button"

    const-string v2, "id"

    .line 38
    invoke-static {v1, v2}, Lpl/jakubweg/VotingButton;->getIdentifier(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v2, "Couldn\'t find imageView with tag \"voting_button\""
    ...
    .line 44
    :cond_2
    sget-object v1, Lpl/jakubweg/SponsorBlockUtils;->voteButtonListener:Landroid/view/View$OnClickListener;
    ...
    sput-object v1, Lpl/jakubweg/VotingButton;->_votingButton:Ljava/lang/ref/WeakReference;

    .line 48
    const-string v1, "fade_duration_fast"

    invoke-static {v1}, Lpl/jakubweg/VotingButton;->getInteger(Ljava/lang/String;)I

    move-result v1

    sput v1, Lpl/jakubweg/VotingButton;->fadeDurationFast:I
    ...
    sput v1, Lpl/jakubweg/VotingButton;->fadeDurationScheduled:I

    .line 50
    const-string v1, "fade_in"

    invoke-static {v1}, Lpl/jakubweg/VotingButton;->getAnimation(Ljava/lang/String;)Landroid/view/animation/Animation;

    move-result-object v1

    sput-object v1, Lpl/jakubweg/VotingButton;->fadeIn:Landroid/view/animation/Animation;

    .line 51
    sget v2, Lpl/jakubweg/VotingButton;->fadeDurationFast:I
    ...
    sput-object v1, Lpl/jakubweg/VotingButton;->fadeOut:Landroid/view/animation/Animation;

    .line 53
    sget v2, Lpl/jakubweg/VotingButton;->fadeDurationScheduled:I
    ...
    sput-boolean v1, Lpl/jakubweg/VotingButton;->isShowing:Z

    .line 55
    const/4 v1, 0x0

    invoke-static {v1}, Lpl/jakubweg/VotingButton;->changeVisibilityImmediate(Z)V
    :try_end_0
